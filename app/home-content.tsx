...
type MobileTab = 'models' | 'stations' | 'map'

const MOBILE_TABS: Array<{ id: MobileTab; labelEn: string; labelEs: string; icon: React.ReactNode }> = [
  {
    id: 'models',
    labelEn: 'Models',
    labelEs: 'Modelos',
...
function MobileTabBar({ active, onChange }: { active: MobileTab; onChange: (next: MobileTab) => void }) {
