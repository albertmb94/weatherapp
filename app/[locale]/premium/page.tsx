  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-8">
        <LocaleLink href="/" className="text-xs text-text-tertiary hover:underline">← Volver</LocaleLink>
        ...
        <footer className="text-xs text-text-tertiary space-x-3">
          <LocaleLink href="/terms" className="hover:underline">Términos</LocaleLink>
          <LocaleLink href="/privacy" className="hover:underline">Privacidad</LocaleLink>
          <LocaleLink href="/cookies" className="hover:underline">Cookies</LocaleLink>
          <LocaleLink href="/affiliate-disclosure" className="hover:underline">Afiliados</LocaleLink>
        </footer>
      </div>
    </div>
  )
