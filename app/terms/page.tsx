...
function Es() {
  return (
    <article className="space-y-4 text-sm">
      ...
      <p>Las suscripciones se procesan a través de Stripe. Puedes cancelar en cualquier momento desde el portal de cliente al que accederás al recibir el email de bienvenida. Las cancelaciones surten efecto al final del período de facturación en curso.</p>
...
function En() {
  return (
    <article className="space-y-4 text-sm">
      ...
      <p>Subscriptions are processed through Stripe. You can cancel at any time from the customer portal link sent in your welcome email. Cancellations take effect at the end of the current billing period.</p>
